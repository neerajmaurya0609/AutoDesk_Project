...
public class TC_13_CreateOrganizationWithRatingIsWorkingOrNotTest extends BaseClass {	
	
	@Test(groups="regrassion_test")
	public void createOrganizationWithRatingIsWorkingOrNot() throws Throwable {
		...
		boolean rating = cnop.getRatingDropDown().isEnabled();
